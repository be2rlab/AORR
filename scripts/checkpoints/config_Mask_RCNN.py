...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='UOAIS-Sim', name='Mask-RCNN', reinit=False))
    ],
    by_epoch=True)
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='UOAIS-Sim/annotations/coco_anns_uoais_sim_train.json',
        img_prefix='./UOAIS-Sim/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='UOAIS-Sim/annotations/coco_anns_uoais_sim_val.json',
        img_prefix='./UOAIS-Sim/val',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        ...
        classes=('object', )))
work_dir = '/home/server3090/Nenakhov/uoais_sim/mask_RCNN'
gpu_ids = [0]
seed = 42
